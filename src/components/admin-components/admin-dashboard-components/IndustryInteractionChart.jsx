...
const IndustryInteractionsChart = ({ data }) => {
    ...
    datasets: [
      {
        ...
        backgroundColor: ["rgba(60, 191, 174, 0.8)", "rgba(60, 191, 174, 0.6)", "rgba(60, 191, 174, 0.4)"],
        borderColor: ["rgba(60, 191, 174, 1)", "rgba(60, 191, 174, 1)", "rgba(60, 191, 174, 1)"],
        borderWidth: 1,
      },
    ],
  };
  ...
  return (
    <div className="bg-[#1a1e24] rounded-lg border border-[#2a2e34] p-4">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-4">
        <h2 className="font-semibold text-white text-base">Industry Interactions</h2>
...
export default IndustryInteractionsChart;
